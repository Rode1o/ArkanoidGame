...
ABallBound::ABallBound()
{
	...
	Box_Collision = CreateDefaultSubobject<UBoxComponent>(TEXT("BoxColision"));
...
void ABallBound::BeginPlay()
{
	...
	PlayerControllerREF = Cast<APaddle_Controller>(UGameplayStatics::GetPlayerController(GetWorld(), 0));
}
